#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Sakil Ahmad
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://.youtube.com/channel/dohatechbd')
    else:
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://m.youtube.com/channel/dohatechbd')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
